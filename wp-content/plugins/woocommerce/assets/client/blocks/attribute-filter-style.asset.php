...
=======
<?php return array('dependencies' => array('lodash', 'react', 'wc-blocks-components', 'wc-blocks-data-store', 'wc-settings', 'wc-types', 'wp-a11y', 'wp-block-editor', 'wp-blocks', 'wp-components', 'wp-compose', 'wp-data', 'wp-deprecated', 'wp-dom', 'wp-element', 'wp-html-entities', 'wp-i18n', 'wp-is-shallow-equal', 'wp-keycodes', 'wp-polyfill', 'wp-primitives', 'wp-url', 'wp-warning'), 'version' => '4829e6dd8ea5f1c11af7');
