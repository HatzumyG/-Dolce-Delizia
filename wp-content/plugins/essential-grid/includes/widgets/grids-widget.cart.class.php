...
class Essential_Grids_Widget_Cart extends WP_Widget
{
	...
	public function __construct()
	{
		...
		$widget_ops = ['classname' => 'widget_ess_grid_cart', 'description' => esc_attr__('Display the WooCommerce Cart of a certain Grid (Grid Navigation Settings in Navigations tab of the Grid has to be set to Widget)', 'essential-grid')];
		parent::__construct('ess-grid-widget-cart', esc_attr__('Essential Grid WooCommerce Cart', 'essential-grid'), $widget_ops);
	}
