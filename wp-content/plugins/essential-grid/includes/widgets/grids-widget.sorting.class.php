...
class Essential_Grids_Widget_Sorting extends WP_Widget
{
	...
	public function __construct()
	{
		...
		$widget_ops = ['classname' => 'widget_ess_grid_sorting', 'description' => esc_attr__('Display the Sorting of a certain Grid (Grid Navigation Settings in Navigations tab of the Grid has to be set to Widget)', 'essential-grid')];
		parent::__construct('ess-grid-widget-sorting', esc_attr__('Essential Grid Sorting', 'essential-grid'), $widget_ops);
	}
