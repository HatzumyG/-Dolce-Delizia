...
class Essential_Grids_Widget_Pagination extends WP_Widget
{
	...
	public function __construct()
	{
		...
		$widget_ops = ['classname' => 'widget_ess_grid_pagination', 'description' => esc_attr__('Display the pagination of a certain Grid (Grid Navigation Settings in Navigations tab of the Grid has to be set to Widget)', 'essential-grid')];
		parent::__construct('ess-grid-widget-pagination', esc_attr__('Essential Grid Pagination', 'essential-grid'), $widget_ops);
	}
