...
class Essential_Grid
{
	...
	public static function enqueue_tptools()
	{
		...
		if ( $enqueue ) wp_enqueue_script('tp-tools', ESG_PLUGIN_URL . 'public/assets/js/libs/tptools.js', [], ESG_TP_TOOLS, ['strategy' => 'async']);
		...
		wp_add_inline_script('tp-tools', preg_replace('/\s+/S', " ", $js), 'before');
