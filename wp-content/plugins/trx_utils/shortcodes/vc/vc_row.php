...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Sweet Dessert
	 * @var $inverse	- added by Sweet Dessert
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Sweet Dessert:
	// Color scheme
	if ($scheme && !sweet_dessert_param_is_off($scheme) && !sweet_dessert_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !sweet_dessert_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Sweet Dessert color scheme in the row
	if ($scheme && !sweet_dessert_param_is_off($scheme) && !sweet_dessert_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php sweet_dessert_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php sweet_dessert_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
