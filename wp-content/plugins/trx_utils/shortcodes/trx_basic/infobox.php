...
/* Theme setup section
-------------------------------------------------------------------- */
if (!function_exists('sweet_dessert_sc_infobox_theme_setup')) {
	add_action( 'sweet_dessert_action_before_init_theme', 'sweet_dessert_sc_infobox_theme_setup' );
	function sweet_dessert_sc_infobox_theme_setup() {
		add_action('sweet_dessert_action_shortcodes_list', 		'sweet_dessert_sc_infobox_reg_shortcodes');
		if (function_exists('sweet_dessert_exists_visual_composer') && sweet_dessert_exists_visual_composer())
			add_action('sweet_dessert_action_shortcodes_list_vc','sweet_dessert_sc_infobox_reg_shortcodes_vc');
	}
}
...
if (!function_exists('sweet_dessert_sc_infobox')) {	
	function sweet_dessert_sc_infobox($atts, $content=null){	
		...
		$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '') 
				. ' class="sc_infobox sc_infobox_style_' . esc_attr($style) 
					. (sweet_dessert_param_is_on($closeable) ? ' sc_infobox_closeable' : '') 
					. (!empty($class) ? ' '.esc_attr($class) : '') 
					. ($icon!='' && !sweet_dessert_param_is_inherit($icon) ? ' sc_infobox_iconed '. esc_attr($icon) : '') 
					. '"'
				...
				. trim($content)
				. '</div>';
		return apply_filters('sweet_dessert_shortcode_output', $output, 'trx_infobox', $atts, $content);
	}
	add_shortcode('trx_infobox', 'sweet_dessert_sc_infobox');
}
...
-------------------------------------------------------------------- */
if ( !function_exists( 'sweet_dessert_sc_infobox_reg_shortcodes' ) ) {
	function sweet_dessert_sc_infobox_reg_shortcodes() {
	
		sweet_dessert_sc_map("trx_infobox", array(
...
-------------------------------------------------------------------- */
if ( !function_exists( 'sweet_dessert_sc_infobox_reg_shortcodes_vc' ) ) {
	function sweet_dessert_sc_infobox_reg_shortcodes_vc() {
		...
		class WPBakeryShortCode_Trx_Infobox extends Sweet_Dessert_VC_ShortCodeContainer {}
	}
}
?>