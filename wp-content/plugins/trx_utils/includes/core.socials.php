...
if (!function_exists('sweet_dessert_socials_theme_setup')) {
	...
	function sweet_dessert_socials_theme_setup() {
        ...
        if (!function_exists('sweet_dessert_socials_theme_setup1')) {
            add_action('sweet_dessert_action_before_init_theme', 'sweet_dessert_socials_theme_setup1');
            function sweet_dessert_socials_theme_setup1()
            {
