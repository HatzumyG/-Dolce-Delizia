...
if ($show_all_counters && sweet_dessert_strpos($post_options['counters'], 'views')!==false) {
	?>
	<<?php sweet_dessert_show_layout($counters_tag); ?> class="post_counters_item post_counters_views icon-eye-light" title="<?php echo esc_attr( sprintf(esc_attr__('Views - %s', 'sweet-dessert'), $post_data['post_views']) ); ?>" href="<?php echo esc_url($post_data['post_link']); ?>"><span class="post_counters_number"><?php echo esc_html($post_data['post_views']); echo ' '. esc_html__('views', 'sweet-dessert');?></span><?php if (sweet_dessert_strpos($post_options['counters'], 'captions')!==false) echo ' '.esc_html__('Views', 'sweet-dessert'); ?></<?php sweet_dessert_show_layout($counters_tag); ?>>
	<?php
}
...
if ($show_all_counters && sweet_dessert_strpos($post_options['counters'], 'likes')!==false) {
	...
	<a class="post_counters_item post_counters_likes icon-heart-empty <?php echo !empty($allow) ? 'enabled' : 'disabled'; ?>" title="<?php echo !empty($allow) ? esc_attr__('Like', 'sweet-dessert') : esc_attr__('Dislike', 'sweet-dessert'); ?>" href="#"
		...
		data-title-dislike="<?php esc_attr_e('Dislike', 'sweet-dessert'); ?>"><span class="post_counters_number"><?php echo esc_html($post_data['post_likes']); echo ' </span><span>'.esc_html__(' likes', 'sweet-dessert');?></span></a>
	<?php
}
