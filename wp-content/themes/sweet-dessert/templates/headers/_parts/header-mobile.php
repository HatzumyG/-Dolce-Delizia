...
$contact_address_1 = sweet_dessert_get_custom_option('contact_address_1') ? trim(sweet_dessert_get_custom_option('contact_address_1')) : '';
$contact_address_2 = sweet_dessert_get_custom_option('contact_address_2') ? trim(sweet_dessert_get_custom_option('contact_address_2')) : '';
$contact_phone = sweet_dessert_get_custom_option('contact_phone') ? trim(sweet_dessert_get_custom_option('contact_phone')) : '';
$contact_email = sweet_dessert_get_custom_option('contact_email') ? trim(sweet_dessert_get_custom_option('contact_email')) : '';
?>
