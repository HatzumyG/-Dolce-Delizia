...
require_once SWEET_DESSERT_THEME_PATH . 'plugins/plugin.gdpr-framework.php';
require_once SWEET_DESSERT_THEME_PATH . 'plugins/plugin.wp-gdpr-compliance.php';
...
require_once SWEET_DESSERT_THEME_PATH . 'plugins/plugin.trx_updater.php';
require_once SWEET_DESSERT_THEME_PATH . 'plugins/plugin.elegro-payment.php';

if (is_admin()) {
    require_once SWEET_DESSERT_THEME_PATH . 'includes/fixes/fix_urls.php';
}
