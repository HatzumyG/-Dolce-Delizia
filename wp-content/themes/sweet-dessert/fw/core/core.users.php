	...
	function sweet_dessert_users_theme_setup() {
		...
		if ( is_admin() ) {
            ...
            if(function_exists('sweet_dessert_add_fields_in_user_info')){
                add_action( 'show_user_profile',		'sweet_dessert_add_fields_in_user_info' );
                add_action( 'edit_user_profile',		'sweet_dessert_add_fields_in_user_info' );
            }
	
			// Save / update additional fields from profile
            if(function_exists('sweet_dessert_save_fields_in_user_info')){
                add_action( 'personal_options_update',	'sweet_dessert_save_fields_in_user_info' );
                add_action( 'edit_user_profile_update',	'sweet_dessert_save_fields_in_user_info' );
            }
